...
public class AppPreferences implements SharedPreferences {
    ...
    public AppPreferences(Context context, SharedPreferences delegate) {
        this.sharedPref = delegate;
        this.context = context;
    }

    public AppPreferences(Context context) {
        this.sharedPref = context.getSharedPreferences ("fitly", Context.MODE_PRIVATE );
        this.context = context;
    }
    ...
    public class Editor implements SharedPreferences.Editor {
        ...
        public Editor() {
            this.editor = AppPreferences.this.sharedPref.edit ( );
        }
